                                    ...
                                    <div class="dropdown-menu-content">
                                        ...
                                        <ul class="dropdown-brand-list m-b-0">
                                            <?php foreach ($resultBrands as $item) { ?>
                                                <li><a href="<?php echo ($item['count'] == 0) ? "#" : "product.php?brand=" . $item['brand_id']; ?>"><img src="<?php echo $item['brand_image']; ?>" /></a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    </div>
    ...
    <div class="dropdown-menu p-15">
        <form action="product.php" method="GET" name="search_form">
            <div class="input-group">
                <input type="text" placeholder="ค้นหาสินค้า" name="q" class="form-control bg-silver-lighter"
