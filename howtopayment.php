...
<head>
    ...
    <title>รายละเอียดการชําระเงิน</title>
...
<div class="move-left"> <!-- กำหนดขอบรอบและระยะห่างสำหรับบัญชีธนาคาร -->
    <h4>บัญชีธนาคาร</h4>
...
<div style="display: flex;">
    <img src="https://media.discordapp.net/attachments/1120961499196821596/1132938065451692143/8BugUEDv68H9J1cDviLv.png?width=471&height=473" alt="รูปภาพ" class="small-image" />
    <p style="margin-left: 20px; font-size: 18px;"><br><br>ธนาคาร : กรุงไทย จำกัด (มหาชน)<br><br>ชื้่อบัญชี : A&P เครื่องกรองน้ำ<br><br>เลขบัญชี : 827-0-35966-1</p>
</div>
