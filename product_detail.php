        ...
        <div class="product">
                ...
                <div class="product-info">
                    ...
                    <div class="product-info-header">
                        ...
                        <ul class="product-category">
                            <li>ร้าน: <a
                                    href="product.php?shop=<?php echo $row['seller_id']; ?>"><?php echo $row['seller_shop']; ?></a>
                            </li>
                            <li>/</li>
                            <li>ประเภท: <a
                                    href="product.php?category=<?php echo $row['category_id']; ?>"><?php echo $row['category_name']; ?></a>
                    ...
                    <div class="product-purchase-container">
                        ...
                        <?php } else { ?>
                        <button class="btn btn-inverse btn-theme btn-lg width-200"
                            onclick="addCart(<?php echo $row['seller_id']; ?>,'<?php echo $row['seller_shop']; ?>',<?php echo $row['product_id']; ?>, '<?php echo $row['product_name']; ?>', <?php echo $row['product_price']; ?>, '<?php echo $row['product_image']; ?>')">เพิ่มลงในตะกร้า</button>
                        <?php } ?>
            ...
            <div class="product-tab">
                ...
                <ul id="product-tab" class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link active" href="#product-reviews"
                            data-toggle="tab">รีวิวสินค้า (<?php echo $resultReview->num_rows; ?>)</a></li>
                </ul>
                <!-- END #product-tab -->
                                    ...
                                    <form action="process_review.php" name="review_form" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="review_title"
                                                name="review_title" data-parsley-required="true" />
                                        </div>
                                        <div class="form-group">
                                            <label for="review_message">เขียนรีวิว <span
                                                    class="text-danger">*</span></label>
                                            <textarea class="form-control" rows="8" id="review_message"
                                                name="review_message" data-parsley-required="true"></textarea>
                                        </div>
                                        <input type="hidden" name="order_id" value="<?php echo $_POST['order_id']; ?>">
                                        <input type="hidden" name="product_id"
                                            value="<?php echo $row['product_id']; ?>">
                                        <button type="submit"
                                            class="btn btn-inverse btn-theme btn-lg">เขียนรีวิวสินค้าเลย</button>
                                    </form>
                                </div>
                                <?php } ?>
                                <!-- END review-form -->
