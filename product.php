            ...
            <div class="search-sidebar">
                ...
                <form action="product.php" method="GET" name="filter_form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-sm" name="q" placeholder="ป้อนชื่อสินค้า"
                            value="<?php echo (isset($_GET['q']) && $_GET['q'] !== '')? $_GET['q']: ""; ?>" />
                    </div>
                    <div class="m-b-30">
                        <button type="submit" class="btn btn-sm btn-theme btn-inverse"><i
                                class="fa fa-search fa-fw mr-1 ml-n3"></i> ค้นหา</button>
                    </div>
                </form>
