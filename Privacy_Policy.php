...
<head>
    ...
    <title>นโยบายความเป็นส่วนตัวสำหรับลูกค้า | Champ</title>
</head>
...
<body>
    ...
    <div class="body container">
        ...
        <p>บริษัทขายเครื่องกรองน้ำ A&amp;P ให้ความสำคัญกับการคุ้มครองข้อมูลส่วนบุคคลของคุณ โดยนโยบายความเป็นส่วนตัวฉบับนี้ได้อธิบายแนวปฏิบัติเกี่ยวกับการเก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลส่วนบุคคล รวมถึงสิทธิต่าง ๆ ของเจ้าของข้อมูลส่วนบุคคล ตามกฎหมายคุ้มครองข้อมูลส่วนบุคคล</p>
        ...
        <p>บริษัทขายเครื่องกรองน้ำ A&amp;P</p>

        <p>
            104/641 หมู่3 ถนน มะขามเตี้ย เมืองสุราษฎร์ธานี สุราษฎร์ธานี 84000
        </p>

        <p>อีเมล adisak_sd20@hotmail.com</p>
        <p>เว็บไซต์ https://champ.itsvc.dev/</p>
        <p>หมายเลขโทรศัพท์ 0818946364</p>

        <p><b>เจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล</b></p>
        <p>อดิศักดิ์ อิ่มสุขศิลป์</p>
        ...
        <p>อีเมล adisak_sd20@hotmail.com</p>
        <p>หมายเลขโทรศัพท์ 081-894-6364</p>
    </div>
