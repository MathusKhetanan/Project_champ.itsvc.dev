		                            ...
		                            <tbody>
		                                ...
		                                <tr>
		                                    ...
		                                    <td class="text-center"><span
		                                            ...
		                                            style="font-size: 14px"><?php echo $Status[$row['order_status']]; ?></span>
		                                    </td>
		                                    ...
		                                    <td class="text-center">
		                                        <a class="btn btn-outline-info"
		                                            href="order.detail.php?id=<?php echo $row['order_id']; ?>">ดูรายละเอียด</a>
		                                    </td>
		                                    <td class="text-center">
		                                        <button class="btn btn-success"
		                                            <?php echo ($row['order_status'] != "shipping")?"disabled" :"" ?>
		                                            onclick="if(confirm('คุณต้องการลบข้อมูลแบรนด์นี้หรือไม่?')){ location.href = 'process_order.status.php?change_status=<?php echo $row['order_id']; ?>&action=update' };">ยืนยันการรับสินค้า</button>
		                                    </td>
		                                </tr>
		                                <?php } ?>
		                            </tbody>
