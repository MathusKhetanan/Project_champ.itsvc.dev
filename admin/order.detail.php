		    ...
		    <div class="invoice">
		            ...
		            <div class="row">
		                ...
		                <div class="col-7 d-flex justify-content-end">
		                    ...
		                    <form action="process_order.tracking.php" class="row d-flex justify-content-end" method="POST">
		                        <input type="text" class="form-control w-50 mr-3" id="order_tracking" name="order_tracking"
		                            placeholder="กรอกหมายเลขพัสดุ" required>
		                        <button type="submit" class="btn btn-<?php echo $StatusColor['shipping']; ?>"
		                            name="change_status" value="<?php echo $row['order_id']; ?>">อัพเดทหมายเลขพัสดุ</button>
		                    </form>
		                    <?php } ?>
		                </div>
		            </div>
		        ...
		        <div class="invoice-header">
		            ...
		            <div class="invoice-date">
		                <small>สถานะออเดอร์ / <span class="badge bg-<?php echo $StatusColor[$row['order_status']]; ?>"
		                ...
		                <div class="invoice-price-left">
		                    <div class="invoice-price-row">
		                        ...
		                        <div class="sub-price">
		                            <small>FEE + VAT</small>
		                            <span
		                                class="text-inverse"><?php echo $row['order_total_free_vat']+$row['order_total_free']; ?></span>
		                        </div>
		                    </div>
		                </div>
