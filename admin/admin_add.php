                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="seller_shop" name="seller_shop" placeholder="ชื่อร้านค้า" data-parsley-required="true">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label for="seller_detail">รายละเอียดร้าน</label>
                            <textarea class="form-control" id="seller_detail" name="seller_detail" placeholder="รายละเอียดร้าน" data-parsley-required="true"></textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label for="seller_address">ที่อยู่ร้าน</label>
                            <textarea class="form-control" id="seller_address" name="seller_address" placeholder="ที่อยู่ร้าน" data-parsley-required="true"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="seller_email" name="seller_email" placeholder="อีเมล" data-parsley-required="true">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="seller_fullname">ชื่อ-สกุลผู้ขาย</label>
                            <input type="text" class="form-control" id="seller_fullname" name="seller_fullname" placeholder="ชื่อ-สกุลผู้ขาย" data-parsley-required="true">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="seller_tel">เบอร์ติดต่อ</label>
                            <input type="text" class="form-control" id="seller_tel" name="seller_tel" placeholder="เบอร์ติดต่อ" data-parsley-required="true">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="seller_bank_name">ชื่อธนาคาร</label>
                            <input type="text" class="form-control" id="seller_bank_name" name="seller_bank_name" placeholder="ชื่อธนาคาร" data-parsley-required="true">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="seller_account_number">เลขที่บัญชี</label>
                            <input type="text" class="form-control" id="seller_account_number" name="seller_account_number" placeholder="เลขที่บัญชี" data-parsley-required="true">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
