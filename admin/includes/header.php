                                    ...
                                    <div class="dropdown-menu-content">
                                        ...
                                        <ul class="dropdown-brand-list m-b-0">
                                            <?php foreach ($resultBrands as $item) { ?>
                                                <li><a href="<?php echo ($item['count'] == 0) ? "#" : "product.php?brand=" . $item['brand_id']; ?>"><img src="<?php echo $item['brand_image']; ?>" onError="this.src='https://media.discordapp.net/attachments/1128198864629940244/1128967842545545287/logo.png'" /></a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                    ...
                                    <ul class="cart-item">
                                        ...
                                        ?>
                                                <li class="d-flex align-items-center">
                                                    <div class="cart-item-image p-0" style="width: 3rem; height: 2.75rem; border: 0px;"><img src="img/user.png" class="user-img" alt="" />
                                                    </div>
