          ...
          <tr>
            ...
            <td class="text-center">
              <button 
                ...
                onclick="if(confirm('ยืนยันการได้รับเงิน?')){ location.href = 'process_withdraw.php?id=<?php echo substr(md5($row['withdraw_id']), 0, 8); ?>&action=update' }" <?php echo ($row['withdraw_status']!='wait_confirm')?"disabled" : ""; ?> >ยืนยันการได้รับเงิน</button>
            </td>
          </tr>
          <?php } ?>
        </tbody>
